...
ggplot(faa, aes(age,val,group=year)) + geom_line(aes(colour = csum)) + facet_grid(~grp, scales="free_y") + labs(y="Catchability", x="wr") + scale_colour_gradientn(colours = viridis(7), name="Order")
```
