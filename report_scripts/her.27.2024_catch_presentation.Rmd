...
# Version `r paste0(lubridate::today(), "-v2")`

## Row

### Versions

202-03-09-v1 - 1st version

202-03-09-v1 - Updated with Norwegian purse seine biology from the transfer area. Updated plots
...
We have a lot of unsampled strata and strata with very few samples, e.g., in 27.3.a.20 we started with one sample (the 1 Norwegian samples from the ps are from the transfer area)
