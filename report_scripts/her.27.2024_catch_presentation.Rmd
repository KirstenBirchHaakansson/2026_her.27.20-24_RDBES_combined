...
```{r}
canum_3a <- subset(subset(canum_3, catch_t > 0), subFleet == "passive" & area %in% c("27.3.a.20", "27.3.a.21") & year == year_0)

tab <- summarise(group_by(canum_3a, ctry, quarter, subFleet, area, year), catch_ton = sum(catch_t, na.rm = TRUE) / 9)
...
lan_samp <- distinct(
  subset(
    ...
    year == year_0 &
      subFleet == "passive" &
      area %in% c("27.3.b.23", "27.3.c.22", "27.3.d.24") &
      catch_t > 0
  ),
  year,
  catch_t,
...
### Availaible samples, `r year_d` -`r year_0`
