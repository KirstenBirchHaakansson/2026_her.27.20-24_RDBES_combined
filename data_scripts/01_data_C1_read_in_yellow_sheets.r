...
norFile <- "2026 DC HAWG her.27.20-24 NO_v2.xlsx"
...
distinct(canum, area, ctry, subFleet)

canum$subFleet[canum$subFleet == "F - passive"] <- "passive"
distinct(canum, area, ctry, subFleet)
...
distinct(samp, area, ctry, subFleet)

samp$subFleet[samp$subFleet == "F - passive"] <- "passive"
distinct(samp, area, ctry, subFleet)
